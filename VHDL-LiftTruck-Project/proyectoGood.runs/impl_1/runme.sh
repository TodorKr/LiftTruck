...
HD_PWD='C:/Users/user1/Desktop/proyectoGood/proyectoGood.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnection.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interconnection.tcl -notrace
