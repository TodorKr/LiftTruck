...
HD_PWD='C:/Users/user1/Desktop/proyectoGood/proyectoGood.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnection.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnection.tcl
